package com.fabio.ordemservico.controllers.exceptions;
...
@ControllerAdvice
public class ResourceExceptionHandler {  		//A classe será responsável por interceptar a excessão, manipular e lançar ao usuário
